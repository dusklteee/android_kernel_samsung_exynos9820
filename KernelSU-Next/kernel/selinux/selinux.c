...
/* susfs domain checks: reuse KernelSU-Next's cached SIDs.
 * cached_su_sid resolves "u:r:ksu:s0" (this fork's su domain) and
 * cached_zygote_sid resolves "u:r:zygote:s0"; both populated by cache_sid(). */
